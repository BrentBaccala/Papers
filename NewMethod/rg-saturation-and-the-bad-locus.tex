...
\begin{aligned}
  ...
  &\boxed{(a_0+a_1v)\,\Psi'' + (b_0+b_1v)\,\Psi' + (c_0+c_1v)\,\Psi},\\
  &v-(v_1x+v_2y+v_3z+v_4r),\qquad r^2-x^2-y^2-z^2,
\end{aligned}
\end{equation}
...
P_3 &= (v_1^2{+}v_2^2{+}v_3^2,\,a_1,a_0,v_4),\\
P_4 &= (v_4c_0{-}b_0,\,Ec_0{-}v_4c_1,\,Eb_0{-}v_4^2c_1,\,b_1,\,a_1{-}\tfrac12 b_0,\,a_0,v_3,v_2,v_1),\\
