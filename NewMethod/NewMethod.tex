...
\caption{The interrelation between relevant branches of mathematics}
...
32 x^{3} \Psi' r v_{1}^{3} b_{1} + 32 x y^{2} \Psi' r v_{1}^{3} b_{1} + 32 x z^{2} \Psi' r v_{1}^{3} b_{1} + 32 x^{2} y \Psi' r v_{1}^{2} v_{2} b_{1} + \cdots
\end{equation}
