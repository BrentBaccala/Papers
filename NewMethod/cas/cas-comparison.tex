...
f_1 = \xi^{-m/2} e^{\frac{1}{2}\sqrt{-2E}\,\xi}
      \left[ K_1\, M(a',\,1-m,\,-\sqrt{-2E}\,\xi)
           + K_2\, U(a',\,1-m,\,-\sqrt{-2E}\,\xi) \right],
\qquad a' = -\frac{\sqrt{-2E}\,\beta_1 + E m - E}{2E}.
\end{equation}
...
symbolically raises \verb|ZeroDivisionError: symbolic division by zero|,
because its \verb|_derivative_| method forms $a/b$ with $b=1-m$.  The
verification in \verb|f1-ode-sage.sage| is therefore done in mpmath.
...
\verb|xi**(m/2)*exp(-I*k*xi)*hyper((a,),(m+1,),2*I*k*xi)|,
\verb|checkodesol| returns \verb|False| with a 711-operation residual: it
...
\verb|/opt/Wolfram/WolframScript/bin/wolframscript -file f1-ode.wls|,
\verb|python f1-ode-sympy.py|, and
\verb|sage f1-ode-sage.sage|.
