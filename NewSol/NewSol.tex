...
differential equations.  Separation of variables is not required,
and it is not a transform method.  As an illustration of the method,
...
so degree bounds, for example, are required for most polynomials.  No
algorithm is presently available to select an ansatz.
...
Ansatz 5 is a second-order ODE with linear coefficients and a linear variable, i.e:
...
$\Psi'$ and $\Psi''$ are new indeterminates.

\subsection*{Differential Reduction Step}

The Rosenfeld-Gr\"obner algorithm.
...
Ansatz 6   &Helium         &Differential Elimination &Manual                &10 seconds\\
           &               &Sol of constant system   &Singular radical      &laptop crashed after about 1 week\\
           &               &                         &Bertini               &laptop crashed after about 1 week\\
           &               &                         &                      &\\
